...
INC =  -I ~/.brew/Cellar/sdl2/2.0.12_1/include/ \
	   -I ~/.brew/Cellar/glfw/3.3.2/include/ \
	   -I $(LIB_DIR)/includes -I ./includes \
	   -I ~/.brew/Cellar/glew/2.1.0_1/include/ \
...
LIB = -L $(LIB_DIR)/ -lft \
	  -L ~/.brew/Cellar/glfw/3.3.2/lib/ -lglfw \
	  -L ~/.brew/Cellar/glew/2.1.0_1/lib/ -lGLEW \
	  -L ~/.brew/Cellar/sdl2_image/2.0.5/lib/ -lSDL2_image \
	  -L ~/.brew/Cellar/sdl2/2.0.12_1/lib/ -lSDL2
